...
class FloodQueries {
	 ...
	 *
	 * @param string $ipHash The hash of the poster's IP address.
	 ...
	 */
	public function getRecentFloodEntries(string $ipHash, string $postHash, ?string $fileHash = null): array {
	 ...
	 *
	 * @param string $ip The hash of the poster's IP address.
	 * @param string $posthash The hash of the post body content.
