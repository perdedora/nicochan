...
use Vichan\Data\{ReportQueries, ArchiveQueries, ShadowQueries, UserPostQueries, IpNoteQueries, FloodQueries};
use Vichan\Service\{HCaptchaQuery, SecureImageCaptchaQuery, ReCaptchaQuery, YandexCaptchaQuery, 
					RemoteCaptchaQuery, FloodService, FilterService};
